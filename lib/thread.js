...
(function() {
  var AuthenticateClient, Base, Config, KeyManager, SessionClient, Thread, ThreadClient, UserSet, chris, donnie, err, iced, idg, log, main, make_esc, max, rc, unlocker, __iced_deferrals, __iced_k, __iced_k_noop, _ref, _ref1,
    ...
    ThreadClient.prototype.authenticate = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          auth.authenticate(esc(__iced_deferrals.defer({
