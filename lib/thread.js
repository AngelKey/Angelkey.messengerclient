...
(function() {
  var AuthorizeClient, Base, Config, KeyManager, SessionClient, Thread, ThreadClient, UserSet, chris, donnie, err, iced, idg, log, main, make_esc, max, rc, unlocker, __iced_deferrals, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  AuthorizeClient = require('./authorize').AuthorizeClient;
  ...
  exports.ThreadClient = ThreadClient = (function(_super) {
    ...
    ThreadClient.prototype.get_authorize_klass = function() {
      return AuthorizeClient;
    };

    ThreadClient.prototype.authorize = function(_arg, cb) {
      var auth, esc, klass, user, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      user = _arg.user;
      user || (user = this.me);
      esc = make_esc(cb, "Client::authorize");
      klass = this.get_authorize_klass();
      auth = new klass({
        thread: this.thread,
        user: user,
        cfg: this.cfg
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/max/src/keybase/messenger-client/src/thread.iced",
            funcname: "ThreadClient.authorize"
          });
          auth.authorize(esc(__iced_deferrals.defer({
            assign_fn: (function(__slot_1) {
              return function() {
                return __slot_1.thread_auth_km = arguments[0];
              };
            })(_this),
            lineno: 54
          })));
        ...
        (function(__iced_k) {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              cli.authorize({}, esc(__iced_deferrals.defer({
                lineno: 94
              })));
              __iced_deferrals._fulfill();
            })(function() {
