...
(function() {
  var Authorizer, Base, Config, SessionClient, Thread, ThreadClient, UserSet, chris, donnie, err, iced, idg, log, main, make_esc, max, rc, __iced_deferrals, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  Authorizer = require('./authorize').Authorizer;
    ...
    ThreadClient.prototype.authorize = function(arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          auth.gen_authorize_message(esc(__iced_deferrals.defer({
