...
(function() {
  var AuthenticateClient, Base, C, Config, KeyManager, SessionClient, Thread, UserSet, burn, iced, idg, kbmc, kbpgp, log, make_esc, pack, unix_time, __iced_k, __iced_k_noop, _ref,
  ...
  burn = kbpgp.burn, KeyManager = kbpgp.KeyManager;
  ...
  exports.AuthenticateClient = AuthenticateClient = (function(_super) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/max/src/keybase/messenger-client/src/authenticate.iced",
    ...
    AuthenticateClient.prototype.sign = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          burn({
            msg: msg,
            signing_key: _this.privkeys.sign
    ...
    AuthenticateClient.prototype.generate = function(cb) {
      var KF, args, esc, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
