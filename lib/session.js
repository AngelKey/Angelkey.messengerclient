...
(function() {
  var Base, SessionClient, WordArray, buffer_cmp_ule, checkers, iced, log, make_esc, scrypt, test, tsec, util, __iced_k, __iced_k_noop,
            ...
            if (!!((_positive === true && i >= 1000000) || (_positive === false && i <= 1000000))) {
              ...
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  ...
                  filename: "/Users/max/src/keybase/messenger-client/src/session.iced",
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              log.debug("- init_session");
              return cb(null, body.session_id);
            });
          });
        };
      })(this));
