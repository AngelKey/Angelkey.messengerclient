...
(function() {
  var E, KeyManager, Thread, User, UserSet, athrow, buffer_cmp_ule, iced, make_esc, prng, rando, tsec, __iced_k, __iced_k_noop;
  ...
  exports.User = User = (function() {
    ...
    User.prototype.gen_init_msg = function(_arg, cb) {
      ...
      payload.t = this.t;
      msg = this.cfg.encode_to_buffer(payload);
      err = null;
      (function(_this) {
        return (function(__iced_k) {
          if ((encryption_key = km.find_crypt_pgp_key()) == null) {
