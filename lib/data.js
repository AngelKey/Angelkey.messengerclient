...
(function() {
  ...
  exports.User = User = (function() {
    ...
    User.prototype.get_signing_key = function(cb) {
      var err, ret;
      err = this.private_km == null ? new Error("No private key manager available") : this.private_km.is_pgp_locked() ? new Error("Private key is PGP-locked") : (ret = this.private_km.find_signing_pgp_key()) == null ? new Error("no signing key") : null;
      return cb(err, key);
    };
