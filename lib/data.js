...
(function() {
  ...
  exports.User = User = (function() {
    ...
    User.prototype.get_private_keys = function(cb) {
      var err, keys;
      keys = {};
      err = this.private_km == null ? new Error("No private key manager available") : this.private_km.is_pgp_locked() ? new Error("Private key is PGP-locked") : (this.ret.sign = this.private_km.find_signing_pgp_key()) == null ? new Error("no signing key") : (this.ret.crypt = this.private_km.find_crypt_pgp_key()) == null ? new Error("no crypt key") : null;
      return cb(err, keys);
    };
