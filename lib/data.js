...
(function() {
  var Cipher, E, H, KeyManager, Thread, User, UserSet, athrow, buffer_cmp_ule, burn, iced, idg, kbmc, make_esc, prng, strong_random, tsec, __iced_k, __iced_k_noop, _ref;
  ...
  exports.User = User = (function() {
    function User(_arg) {
      this.fingerprint = _arg.fingerprint, this.display_name = _arg.display_name, this.public_key = _arg.public_key, this.inbox_server = _arg.inbox_server, this.is_me = _arg.is_me, this.private_km = _arg.private_km;
      this.i = null;
      this.t = null;
      this.km = null;
      this.zid = null;
