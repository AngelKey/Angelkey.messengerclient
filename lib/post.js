...
(function() {
  var Base, C, Cipher, Config, KeyManager, PostMessageClient, SessionClient, Streamer, Thread, UserSet, bufferify, burn, checkers, detachsign, dict_merge, frame, hash, iced, kbmc, log, make_esc, unix_time, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  _ref2 = require('iced-utils').util, dict_merge = _ref2.dict_merge, bufferify = _ref2.bufferify, unix_time = _ref2.unix_time;
              ...
              if (_this.stream != null) {
                (function(__iced_k) {
                  __iced_deferrals = new iced.Deferrals(__iced_k, {
                    ...
                    filename: "/Users/max/src/keybase/messenger-client/src/post.iced",
  ...
  exports.PostMessageClient = PostMessageClient = (function(_super) {
    ...
    PostMessageClient.prototype.base_data = function() {
      return {
        i: this.thread.i,
        t: this.from.t,
    ...
    PostMessageClient.prototype.post_header = function(cb) {
      ...
      arg = {
        endpoint: "msg/header",
        method: "POST",
        data: dict_merge(this.base_data(), {
          etime: 0,
      ...
      (function(_this) {
        ...
        return function() {
          ...
          arg = {
            endpoint: "msg/chunk",
            method: "POST",
            data: dict_merge(_this.base_data(), {
              ctext: ctext,
